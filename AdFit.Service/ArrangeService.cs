...
namespace AdFit.Service
{
    public class ArrangeService : IArrangeService
    {
        ...
        public void PlacingAdvertisementsOnPages()
        {
            ...
            FillingHolesAndSendingToCustomers();
       ...
       public void SendEmail(User u,string subject, string msg)
        {
            ...
            mailMessage.From = new MailAddress("tamar21487@gmail.com.com");
            mailMessage.To.Add("tamar21487@gmail.com");
            ...
            smtpClient.Credentials = new NetworkCredential("tamar21487@gmail.com", "rqsz fmth gbec rxdu");
